...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "7GMsOT-hewqVly_y8C3Ijgb95e2nezH00VDsbqHKPHs" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/novatour-logo.png" },
          ...
          "@graph": [
            {
              ...
              logo: "https://novatour.fr/novatour-logo.png",
              description:
